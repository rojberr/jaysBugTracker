...
<html lang="en">
<head>
    <base href="https://beetle-tracker.herokuapp.com/" />
    <meta charset="utf-8" />
    ...
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-item c-sidebar-nav-dropdown">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item">
                    ...
                    ><span class="c-sidebar-nav-icon"></span> Buttons</a
                    >
                </li>
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link" href="buttons/button-group.html"
                    ><span class="c-sidebar-nav-icon"></span> Buttons Group</a
                    >
                </li>
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link" href="buttons/dropdowns.html"
                    ><span class="c-sidebar-nav-icon"></span> Dropdowns</a
                    >
                </li>
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link" href="buttons/brand-buttons.html"
                    ><span class="c-sidebar-nav-icon"></span> Brand Buttons</a
                    >
                </li>
            </ul>
        </li>
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link" href="icons/coreui-icons-free.html">
                        CoreUI Icons<span class="badge badge-success">Free</span></a
                    >
                </li>
                <li class="c-sidebar-nav-item">
                    <a
        ...
        <li class="c-sidebar-nav-item c-sidebar-nav-dropdown">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item">
                    ...
                    ><span class="c-sidebar-nav-icon"></span> Alerts</a
                    >
                </li>
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link" href="notifications/badge.html"
                    ><span class="c-sidebar-nav-icon"></span> Badge</a
                    >
                </li>
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link" href="notifications/modals.html"
                    ><span class="c-sidebar-nav-icon"></span> Modals</a
                    >
                </li>
            </ul>
        </li>
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link" href="widgets.html">
                ...
                Widgets<span class="badge badge-info">NEW</span></a
            >
        </li>
                                            ...
                                            <td class="text-center">
                                                <div class="c-avatar">
                                                    <img
                                                            ...
                                                            alt="user@email.com"
                                                    /><span
                                                        class="c-avatar-status bg-danger"
                                                ></span>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <div class="c-avatar">
                                                    <img
                                                            ...
                                                            alt="user@email.com"
                                                    /><span
                                                        class="c-avatar-status bg-warning"
                                                ></span>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <div class="c-avatar">
                                                    <img
                                                            ...
                                                            alt="user@email.com"
                                                    /><span
                                                        class="c-avatar-status bg-secondary"
                                                ></span>
                                                </div>
                                            </td>
                                            <td>
